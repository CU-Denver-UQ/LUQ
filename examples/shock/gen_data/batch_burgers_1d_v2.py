...
np.savetxt('burgers_files_v2/unif_params.txt', params)
np.savetxt('burgers_files_v2/unif_times.txt', times)
np.savetxt('burgers_files_v2/unif_series.txt', time_series)
...
np.savetxt('burgers_files_v2/beta_params_2_5.txt', params_obs)
np.savetxt('burgers_files_v2/beta_times_2_5.txt', times_obs)
np.savetxt('burgers_files_v2/beta_series_2_5.txt', time_series_obs)
...
np.savetxt('burgers_files_v2/beta_params_5_2.txt', params_obs)
np.savetxt('burgers_files_v2/beta_times_5_2.txt', times_obs)
