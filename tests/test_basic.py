...
class Test_Selkov(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.learn.clean_data(time_start_idx=time_start_idx, time_end_idx=time_end_idx,
    ...
    def test_kmeans(self):
        ...
        """
        self.learn.dynamics(cluster_method='kmeans', kwargs={'n_clusters': 3, 'n_init': 10})
    ...
    def test_spectral(self):
        ...
        """
        self.learn.dynamics(cluster_method='spectral', kwargs={'n_clusters': 3, 'n_init': 10})
    ...
    def test_gmm(self):
        ...
        """
        self.learn.dynamics(cluster_method='gmm', kwargs={'n_components': 3, 'n_init': 10})
        self.learn.learn_qois_and_transform(variance_rate=0.9)
